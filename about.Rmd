...
map <- ggmap(berlin_images) +
  ...
  labs(size="# of employees",
       ...
       subtitle= "The size of the dots refer to the number of (potential) employees of Sony Music",
...
## *A map of Berlin*
  * The red dots mark the location of the Sony Music headquarters in Berlin and my address
