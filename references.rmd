...
* Here are some examples of data visualisation based on fictive dataframe of students


### Hisogram Chart {.tabset}
* The following histograms show the five most used keys of my favorite pianist Ahmad Jamal. The data is downloaded via an API from my most used streaming platform.
...
* Here you can see the R code of a quick data wrangling process with a final data visualization in a ridgeline plot. The plot shows a distribution of the liking of each course by the students.
